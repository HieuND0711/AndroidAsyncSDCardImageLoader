package com.android.asyncsdcard.imageloader;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent i) {
		...
		case REQ_CODE_PICK_IMAGE:
			if (resultCode == RESULT_OK) {
				...
				Cursor c = getContentResolver().query(selectedImage, filePathColumn, null, null,
						null);
				if (c == null)
					return;
				c.moveToFirst();
				...
				// get a reference to the ImageView and using the SDImageLoader
